...
/* 按键口对应的RCC时钟 */
#define RCC_ALL_LED 	(RCC_APB2Periph_GPIOG)
#define RCC_POW_RES 	(RCC_APB2Periph_GPIOB)
...
#define GPIO_PIN_LED4	GPIO_Pin_14
...
void bsp_InitLed(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_POW_RES, ENABLE);
	...
	*/
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_PIN_POW_RESET;
	GPIO_Init(GPIO_PORT_POW_RESET, &GPIO_InitStructure);
}
